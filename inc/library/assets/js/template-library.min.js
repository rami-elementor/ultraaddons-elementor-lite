! function(e, t, i) {
    ...
    a.Models.Template = Backbone.Model.extend({
        ...
        FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", $openLibraryButton = '<div class="elementor-add-section-area-button elementor-add-ua-button"> <i class="uicon-ultraaddons"></i><span class="elementor-add-ua-button-text">'+templateButtonText+'</span> </div>', 
